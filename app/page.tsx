...
// Parses ==word== syntax into highlighted spans
...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ fontFamily: "var(--font-lora), Georgia, serif", fontWeight: 700, fontSize: 24, letterSpacing: "-0.3px", fontStyle: "italic" }}>Beautiful Screen Shot</span>
      </header>
                ...
                <div style={{ display: "flex", gap: 8 }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      fontWeight: 600,
                      fontSize: 14,
                      opacity: loading || !tweetUrl.trim() ? 0.5 : 1,
                      whiteSpace: "nowrap",
                    }}
                  >
                    {loading ? "…" : "Fetch"}
